      ...
      <main className="flex-1 px-4 py-12 flex flex-col items-center justify-center gap-6 text-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-[hsl(var(--muted-foreground))] max-w-[280px] leading-relaxed">
            O cadastro de cartoes esta sendo implementado com integracao segura via Stripe.
            Por enquanto, o pagamento e feito diretamente no checkout.
          </p>
        </div>

        <div className="flex items-center gap-2 text-[hsl(var(--muted-foreground))]">
          <ShieldCheck size={14} />
          <p className="text-xs">Pagamentos processados com seguranca pelo Stripe.</p>
        </div>
